...
class CategorieCrudController extends AbstractController
{
    ...
    public function index(): Response
    {
        ...
        return $this->render('ProduitTemplate/categorie/index.html.twig', [
            'categories' => $items,
        ]);
    }
    ...
    public function new(Request $request): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            if (count($errors) > 0) {
                ...
                return $this->render('ProduitTemplate/categorie/new.html.twig', [
                    'categorie' => $categorie,
                    'form' => $form,
                ]);
            }
    ...
    public function show(int $id): Response
    {
        ...
        return $this->render('ProduitTemplate/categorie/show.html.twig', [
            'categorie' => $categorie,
        ]);
    }
    ...
    public function edit(Request $request, int $id): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            if (count($errors) > 0) {
                ...
                return $this->render('ProduitTemplate/categorie/edit.html.twig', [
                    'categorie' => $categorie,
                    'form' => $form,
                ]);
            }
